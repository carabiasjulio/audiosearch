...
class SearchFrame(wx.Frame):
    def __init__(self, ):
        ...
        psizer.Add(FeedbackSampleBar(random_audio_file(), samplePanel))
        psizer.Add(FeedbackSampleBar(random_audio_file(), samplePanel))
        psizer.Add(FeedbackSampleBar(random_audio_file(), samplePanel))
...
class FeedbackSampleBar(BasicSampleBar):
    """ Sample bar with label control"""
    def __init__(self, sampleFile, parent):
        BasicSampleBar.__init__(self, sampleFile, parent)
        rbsizer = wx.BoxSizer()
